...
pub const ResourceV1AllocatedDeviceStatus = struct {
    ...
    networkData: ?ResourceV1NetworkDeviceData = null,
...
pub const ResourceV1AllocationResult = struct {
...
pub const ResourceV1CapacityRequestPolicy = struct {
    ...
    validRange: ?ResourceV1CapacityRequestPolicyRange = null,
    /// ValidValues defines a set of acceptable quantity values in consuming requests.
    validValues: ?[]const api_resource.ApiResourceQuantity = null,
};

/// CapacityRequestPolicyRange defines a valid range for consumable capacity values.
pub const ResourceV1CapacityRequestPolicyRange = struct {
...
pub const ResourceV1CapacityRequirements = struct {
...
pub const ResourceV1Counter = struct {
...
pub const ResourceV1CounterSet = struct {
    /// Counters defines the set of counters for this CounterSet The name of each counter must be unique in that set and must be a DNS label.
    counters: json.ArrayHashMap(ResourceV1Counter),
    /// Name defines the name of the counter set. It must be a DNS label.
    name: []const u8,
};

/// Device represents one individual hardware instance that can be selected based on its attributes. Besides the name, exactly one field must be set.
pub const ResourceV1Device = struct {
    /// AllNodes indicates that all nodes have access to the device.
    allNodes: ?bool = null,
    /// AllowMultipleAllocations marks whether the device is allowed to be allocated to multiple DeviceRequests.
    allowMultipleAllocations: ?bool = null,
    /// Attributes defines the set of attributes for this device. The name of each attribute must be unique in that set.
    attributes: ?json.ArrayHashMap(ResourceV1DeviceAttribute) = null,
    ...
    capacity: ?json.ArrayHashMap(ResourceV1DeviceCapacity) = null,
    ...
    nodeAllocatableResources: ?json.ArrayHashMap(ResourceV1NodeAllocatableResource) = null,
    /// NodeName identifies the node where the device is available.
    nodeName: ?[]const u8 = null,
    /// NodeSelector defines the nodes where the device is available.
    nodeSelector: ?core_v1.CoreV1NodeSelector = null,
    /// If specified, these are the driver-defined taints.
    taints: ?[]const ResourceV1DeviceTaint = null,
};

/// DeviceAllocationConfiguration gets embedded in an AllocationResult.
pub const ResourceV1DeviceAllocationConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1OpaqueDeviceConfiguration = null,
...
pub const ResourceV1DeviceAllocationResult = struct {
    /// This field is a combination of all the claim and class configuration parameters. Drivers can distinguish between those based on a flag.
    config: ?[]const ResourceV1DeviceAllocationConfiguration = null,
    /// Results lists all allocated devices.
    results: ?[]const ResourceV1DeviceRequestAllocationResult = null,
};
...
pub const ResourceV1DeviceCapacity = struct {
    ...
    requestPolicy: ?ResourceV1CapacityRequestPolicy = null,
    /// Value defines how much of a certain capacity that device has.
    value: api_resource.ApiResourceQuantity,
};

/// DeviceClaim defines how to request devices with a ResourceClaim.
pub const ResourceV1DeviceClaim = struct {
    /// This field holds configuration for multiple potential drivers which could satisfy requests in this claim. It is ignored while allocating the claim.
    config: ?[]const ResourceV1DeviceClaimConfiguration = null,
    /// These constraints must be satisfied by the set of devices that get allocated for the claim.
    constraints: ?[]const ResourceV1DeviceConstraint = null,
    /// Requests represent individual requests for distinct devices which must all be satisfied. If empty, nothing needs to be allocated.
    requests: ?[]const ResourceV1DeviceRequest = null,
};

/// DeviceClaimConfiguration is used for configuration parameters in DeviceClaim.
pub const ResourceV1DeviceClaimConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1OpaqueDeviceConfiguration = null,
...
pub const ResourceV1DeviceClass = struct {
    pub const resource_meta = .{
        ...
        .namespaced = false,
        .list_kind = ResourceV1DeviceClassList,
    };
    ...
    spec: ?ResourceV1DeviceClassSpec = null,
};

/// DeviceClassConfiguration is used in DeviceClass.
pub const ResourceV1DeviceClassConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1OpaqueDeviceConfiguration = null,
};

/// DeviceClassList is a collection of classes.
pub const ResourceV1DeviceClassList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource classes.
    items: []const ResourceV1DeviceClass,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const ResourceV1DeviceClassSpec = struct {
    /// Config defines configuration parameters that apply to each device that is claimed via this class. Some classses may potentially be satisfied by multiple drivers, so each instance of a vendor configuration applies to exactly one driver.
    config: ?[]const ResourceV1DeviceClassConfiguration = null,
    ...
    selectors: ?[]const ResourceV1DeviceSelector = null,
};

/// DeviceConstraint must have exactly one field set besides Requests.
pub const ResourceV1DeviceConstraint = struct {
...
pub const ResourceV1DeviceCounterConsumption = struct {
...
pub const ResourceV1DeviceDerivedAttribute = struct {
...
pub const ResourceV1DeviceRequest = struct {
    ...
    firstAvailable: ?[]const ResourceV1DeviceSubRequest = null,
    /// Name can be used to reference this request in a pod.spec.containers[].resources.claims entry and in a constraint of the claim.
    name: []const u8,
};

/// DeviceRequestAllocationResult contains the allocation result for one request.
pub const ResourceV1DeviceRequestAllocationResult = struct {
    ...
    tolerations: ?[]const ResourceV1DeviceToleration = null,
};

/// DeviceSelector must have exactly one field set.
pub const ResourceV1DeviceSelector = struct {
    /// CEL contains a CEL expression for selecting a device.
    cel: ?ResourceV1CELDeviceSelector = null,
};

/// DeviceSubRequest describes a request for device provided in the claim.spec.devices.requests[].firstAvailable array. Each is typically a request for a single resource like a device, but can also ask for several identical devices.
pub const ResourceV1DeviceSubRequest = struct {
    ...
    capacity: ?ResourceV1CapacityRequirements = null,
    ...
    derivedAttributes: ?[]const ResourceV1DeviceDerivedAttribute = null,
...
pub const ResourceV1DeviceTaint = struct {
...
pub const ResourceV1DeviceTaintRule = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1",
        ...
        .namespaced = false,
        .list_kind = ResourceV1DeviceTaintRuleList,
    };
    ...
    spec: ResourceV1DeviceTaintRuleSpec,
    /// Status provides information about what was requested in the spec.
    status: ?ResourceV1DeviceTaintRuleStatus = null,
};

/// DeviceTaintRuleList is a collection of DeviceTaintRules.
pub const ResourceV1DeviceTaintRuleList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of DeviceTaintRules.
    items: []const ResourceV1DeviceTaintRule,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1DeviceTaintRuleSpec = struct {
    ...
    deviceSelector: ?ResourceV1DeviceTaintSelector = null,
    /// The taint that gets applied to matching devices.
    taint: ResourceV1DeviceTaint,
};

/// DeviceTaintRuleStatus provides information about an on-going pod eviction.
pub const ResourceV1DeviceTaintRuleStatus = struct {
...
pub const ResourceV1DeviceTaintSelector = struct {
...
pub const ResourceV1DeviceToleration = struct {
...
pub const ResourceV1ExactDeviceRequest = struct {
...
pub const ResourceV1NetworkDeviceData = struct {
...
pub const ResourceV1NodeAllocatableMapping = struct {
...
pub const ResourceV1NodeAllocatableOverhead = struct {
...
pub const ResourceV1NodeAllocatableResource = struct {
    ...
    mapping: ?ResourceV1NodeAllocatableMapping = null,
    ...
    overhead: ?ResourceV1NodeAllocatableOverhead = null,
};

/// OpaqueDeviceConfiguration contains configuration parameters for a driver in a format defined by the driver vendor.
pub const ResourceV1OpaqueDeviceConfiguration = struct {
...
pub const ResourceV1ResourceClaim = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1",
        .kind = "ResourceClaim",
        ...
        .namespaced = true,
        .list_kind = ResourceV1ResourceClaimList,
    };
    ...
    spec: ?ResourceV1ResourceClaimSpec = null,
    /// Status describes whether the claim is ready to use and what has been allocated.
    status: ?ResourceV1ResourceClaimStatus = null,
};

/// ResourceClaimConsumerReference contains enough information to let you locate the consumer of a ResourceClaim. The user must be a resource in the same namespace as the ResourceClaim.
pub const ResourceV1ResourceClaimConsumerReference = struct {
...
pub const ResourceV1ResourceClaimList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource claims.
    items: []const ResourceV1ResourceClaim,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1ResourceClaimSpec = struct {
    /// Devices defines how to request devices.
    devices: ?ResourceV1DeviceClaim = null,
};

/// ResourceClaimStatus tracks whether the resource has been allocated and what the result of that was.
pub const ResourceV1ResourceClaimStatus = struct {
    /// Allocation is set once the claim has been allocated successfully.
    allocation: ?ResourceV1AllocationResult = null,
    /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    devices: ?[]const ResourceV1AllocatedDeviceStatus = null,
    /// ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started. A claim that is in use or might be in use because it has been reserved must not get deallocated.
    reservedFor: ?[]const ResourceV1ResourceClaimConsumerReference = null,
};

/// ResourceClaimTemplate is used to produce ResourceClaim objects.
pub const ResourceV1ResourceClaimTemplate = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1",
        ...
        .namespaced = true,
        .list_kind = ResourceV1ResourceClaimTemplateList,
    };
    ...
    spec: ?ResourceV1ResourceClaimTemplateSpec = null,
};

/// ResourceClaimTemplateList is a collection of claim templates.
pub const ResourceV1ResourceClaimTemplateList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource claim templates.
    items: []const ResourceV1ResourceClaimTemplate,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1ResourceClaimTemplateSpec = struct {
...
pub const ResourceV1ResourcePool = struct {
...
pub const ResourceV1ResourceSlice = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1",
        .kind = "ResourceSlice",
        ...
        .namespaced = false,
        .list_kind = ResourceV1ResourceSliceList,
    };
    ...
    spec: ResourceV1ResourceSliceSpec,
};

/// ResourceSliceList is a collection of ResourceSlices.
pub const ResourceV1ResourceSliceList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource ResourceSlices.
    items: []const ResourceV1ResourceSlice,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1ResourceSliceSpec = struct {
    /// AllNodes indicates that all nodes have access to the resources in the pool.
    allNodes: ?bool = null,
    /// Devices lists some or all of the devices in this pool.
    devices: ?[]const ResourceV1Device = null,
    ...
    pool: ResourceV1ResourcePool,
    /// SharedCounters defines a list of counter sets, each of which has a name and a list of counters available.
    sharedCounters: ?[]const ResourceV1CounterSet = null,
