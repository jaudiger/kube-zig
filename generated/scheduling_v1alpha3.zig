...
pub const SchedulingV1alpha3AllCompositeDisruptionMode = json.ArrayHashMap(json.Value);

/// AllDisruptionMode specifies that children can only be disrupted together.
pub const SchedulingV1alpha3AllDisruptionMode = json.ArrayHashMap(json.Value);

/// BasicSchedulingPolicy indicates that standard Kubernetes scheduling behavior should be used.
pub const SchedulingV1alpha3BasicSchedulingPolicy = json.ArrayHashMap(json.Value);
...
pub const SchedulingV1alpha3CompositeBasicSchedulingPolicy = json.ArrayHashMap(json.Value);
...
pub const SchedulingV1alpha3CompositeDisruptionMode = struct {
    /// all specifies that all children groups can only be disrupted together.
    all: ?SchedulingV1alpha3AllCompositeDisruptionMode = null,
    /// single specifies that children groups can be disrupted independently from each other.
    single: ?SchedulingV1alpha3SingleCompositeDisruptionMode = null,
};
...
pub const SchedulingV1alpha3CompositeGangSchedulingPolicy = struct {
...
pub const SchedulingV1alpha3CompositePodGroup = struct {
    pub const resource_meta = .{
        ...
        .namespaced = true,
        .list_kind = SchedulingV1alpha3CompositePodGroupList,
    };
    ...
    spec: SchedulingV1alpha3CompositePodGroupSpec,
    /// status represents the current observed state of the CompositePodGroup.
    status: ?SchedulingV1alpha3CompositePodGroupStatus = null,
};

/// CompositePodGroupList contains a list of CompositePodGroup resources.
pub const SchedulingV1alpha3CompositePodGroupList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of CompositePodGroups.
    items: []const SchedulingV1alpha3CompositePodGroup,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const SchedulingV1alpha3CompositePodGroupSchedulingConstraints = struct {
    ...
    topology: ?[]const SchedulingV1alpha3TopologyConstraint = null,
};
...
pub const SchedulingV1alpha3CompositePodGroupSpec = struct {
    ...
    disruptionMode: ?SchedulingV1alpha3CompositeDisruptionMode = null,
    ...
    schedulingConstraints: ?SchedulingV1alpha3CompositePodGroupSchedulingConstraints = null,
    ...
    schedulingPolicy: SchedulingV1alpha3CompositePodGroupSchedulingPolicy,
    ...
    workloadRef: SchedulingV1alpha3WorkloadReference,
};

/// CompositePodGroupStatus represents information about the status of a composite pod group.
pub const SchedulingV1alpha3CompositePodGroupStatus = struct {
...
pub const SchedulingV1alpha3CompositePodGroupTemplate = struct {
    ...
    compositePodGroupTemplates: ?[]const SchedulingV1alpha3CompositePodGroupTemplate = null,
    ...
    podGroupTemplates: ?[]const SchedulingV1alpha3PodGroupTemplate = null,
...
pub const SchedulingV1alpha3DisruptionMode = struct {
    /// all specifies that all children can only be disrupted together.
    all: ?SchedulingV1alpha3AllDisruptionMode = null,
    /// single specifies that children can be disrupted independently from each other.
    single: ?SchedulingV1alpha3SingleDisruptionMode = null,
};

/// GangSchedulingPolicy defines the parameters for gang scheduling.
pub const SchedulingV1alpha3GangSchedulingPolicy = struct {
...
pub const SchedulingV1alpha3PodGroup = struct {
    pub const resource_meta = .{
        .group = "scheduling.k8s.io",
        .version = "v1alpha3",
        .kind = "PodGroup",
        .resource = "podgroups",
        .namespaced = true,
        .list_kind = SchedulingV1alpha3PodGroupList,
    };
    ...
    spec: SchedulingV1alpha3PodGroupSpec,
    /// status represents the current observed state of the PodGroup.
    status: ?SchedulingV1alpha3PodGroupStatus = null,
};

/// PodGroupList contains a list of PodGroup resources.
pub const SchedulingV1alpha3PodGroupList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of PodGroups.
    items: []const SchedulingV1alpha3PodGroup,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata.
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const SchedulingV1alpha3PodGroupResourceClaim = struct {
...
pub const SchedulingV1alpha3PodGroupResourceClaimStatus = struct {
...
pub const SchedulingV1alpha3PodGroupSchedulingConstraints = struct {
...
pub const SchedulingV1alpha3PodGroupSchedulingPolicy = struct {
    ...
    basic: ?SchedulingV1alpha3BasicSchedulingPolicy = null,
    ...
    gang: ?SchedulingV1alpha3GangSchedulingPolicy = null,
};

/// PodGroupSpec defines the desired state of a PodGroup.
pub const SchedulingV1alpha3PodGroupSpec = struct {
    ...
    disruptionMode: ?SchedulingV1alpha3DisruptionMode = null,
    ...
    resourceClaims: ?[]const SchedulingV1alpha3PodGroupResourceClaim = null,
    ...
    schedulingConstraints: ?SchedulingV1alpha3PodGroupSchedulingConstraints = null,
    ...
    schedulingPolicy: SchedulingV1alpha3PodGroupSchedulingPolicy,
    ...
    workloadRef: ?SchedulingV1alpha3WorkloadReference = null,
};

/// PodGroupStatus represents information about the status of a pod group.
pub const SchedulingV1alpha3PodGroupStatus = struct {
    /// conditions represent the latest observations of the PodGroup's state.
    conditions: ?[]const meta_v1.MetaV1Condition = null,
    /// resourceClaimStatuses is status of resource claims.
    resourceClaimStatuses: ?[]const SchedulingV1alpha3PodGroupResourceClaimStatus = null,
};

/// PodGroupTemplate represents a template for a set of pods with a scheduling policy.
pub const SchedulingV1alpha3PodGroupTemplate = struct {
...
pub const SchedulingV1alpha3SingleCompositeDisruptionMode = json.ArrayHashMap(json.Value);

/// SingleDisruptionMode specifies that children can be disrupted independently.
pub const SchedulingV1alpha3SingleDisruptionMode = json.ArrayHashMap(json.Value);

/// TopologyConstraint defines a topology constraint for a PodGroup.
pub const SchedulingV1alpha3TopologyConstraint = struct {
...
pub const SchedulingV1alpha3TypedLocalObjectReference = struct {
...
pub const SchedulingV1alpha3Workload = struct {
    pub const resource_meta = .{
        .group = "scheduling.k8s.io",
        .version = "v1alpha3",
        .kind = "Workload",
        .resource = "workloads",
        .namespaced = true,
        .list_kind = SchedulingV1alpha3WorkloadList,
    };
    ...
    spec: SchedulingV1alpha3WorkloadSpec,
};

/// WorkloadList contains a list of Workload resources.
pub const SchedulingV1alpha3WorkloadList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of Workloads.
    items: []const SchedulingV1alpha3Workload,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata.
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const SchedulingV1alpha3WorkloadPodGroupAllDisruptionMode = json.ArrayHashMap(json.Value);

/// WorkloadPodGroupBasicSchedulingPolicy indicates standard Kubernetes scheduling behavior.
pub const SchedulingV1alpha3WorkloadPodGroupBasicSchedulingPolicy = json.ArrayHashMap(json.Value);

/// WorkloadPodGroupDisruptionMode defines how individual pods within a group can be disrupted. Exactly one mode must be set.
pub const SchedulingV1alpha3WorkloadPodGroupDisruptionMode = struct {
    /// all specifies that all pods in the group must be disrupted together.
    all: ?SchedulingV1alpha3WorkloadPodGroupAllDisruptionMode = null,
    /// single specifies that pods can be disrupted independently from each other.
    single: ?SchedulingV1alpha3WorkloadPodGroupSingleDisruptionMode = null,
};

/// WorkloadPodGroupGangSchedulingPolicy defines the parameters for gang (all-or-nothing) scheduling.
pub const SchedulingV1alpha3WorkloadPodGroupGangSchedulingPolicy = struct {
...
pub const SchedulingV1alpha3WorkloadPodGroupResourceClaim = struct {
...
pub const SchedulingV1alpha3WorkloadPodGroupSchedulingConstraints = struct {
...
pub const SchedulingV1alpha3WorkloadPodGroupSchedulingPolicy = struct {
    /// basic specifies that standard, pod-by-pod Kubernetes scheduling behavior should be used.
    basic: ?SchedulingV1alpha3WorkloadPodGroupBasicSchedulingPolicy = null,
    /// gang specifies all-or-nothing scheduling semantics.
    gang: ?SchedulingV1alpha3WorkloadPodGroupGangSchedulingPolicy = null,
};

/// WorkloadPodGroupSingleDisruptionMode indicates that individual pods can be disrupted independently.
pub const SchedulingV1alpha3WorkloadPodGroupSingleDisruptionMode = json.ArrayHashMap(json.Value);
...
pub const SchedulingV1alpha3WorkloadReference = struct {
...
pub const SchedulingV1alpha3WorkloadSpec = struct {
    ...
    controllerRef: ?SchedulingV1alpha3TypedLocalObjectReference = null,
