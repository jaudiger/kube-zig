...
pub const ResourceV1beta2AllocatedDeviceStatus = struct {
    ...
    networkData: ?ResourceV1beta2NetworkDeviceData = null,
...
pub const ResourceV1beta2AllocationResult = struct {
    ...
    devices: ?ResourceV1beta2DeviceAllocationResult = null,
    /// NodeSelector defines where the allocated resources are available. If unset, they are available everywhere.
    nodeSelector: ?core_v1.CoreV1NodeSelector = null,
};

/// CELDeviceSelector contains a CEL expression for selecting a device.
pub const ResourceV1beta2CELDeviceSelector = struct {
    /// Expression is a CEL expression which evaluates a single device. It must evaluate to true when the device under consideration satisfies the desired criteria, and false when it does not. Any other result is an error and causes allocation of devices to abort.
    expression: []const u8,
};

/// CapacityRequestPolicy defines how requests consume device capacity.
pub const ResourceV1beta2CapacityRequestPolicy = struct {
    ...
    validRange: ?ResourceV1beta2CapacityRequestPolicyRange = null,
    /// ValidValues defines a set of acceptable quantity values in consuming requests.
    validValues: ?[]const api_resource.ApiResourceQuantity = null,
};

/// CapacityRequestPolicyRange defines a valid range for consumable capacity values.
pub const ResourceV1beta2CapacityRequestPolicyRange = struct {
...
pub const ResourceV1beta2CapacityRequirements = struct {
...
pub const ResourceV1beta2Counter = struct {
...
pub const ResourceV1beta2CounterSet = struct {
    /// Counters defines the set of counters for this CounterSet The name of each counter must be unique in that set and must be a DNS label.
    counters: json.ArrayHashMap(ResourceV1beta2Counter),
    /// Name defines the name of the counter set. It must be a DNS label.
    name: []const u8,
};

/// Device represents one individual hardware instance that can be selected based on its attributes. Besides the name, exactly one field must be set.
pub const ResourceV1beta2Device = struct {
    /// AllNodes indicates that all nodes have access to the device.
    allNodes: ?bool = null,
    /// AllowMultipleAllocations marks whether the device is allowed to be allocated to multiple DeviceRequests.
    allowMultipleAllocations: ?bool = null,
    /// Attributes defines the set of attributes for this device. The name of each attribute must be unique in that set.
    attributes: ?json.ArrayHashMap(ResourceV1beta2DeviceAttribute) = null,
    ...
    capacity: ?json.ArrayHashMap(ResourceV1beta2DeviceCapacity) = null,
    ...
    nodeAllocatableResources: ?json.ArrayHashMap(ResourceV1beta2NodeAllocatableResource) = null,
    /// NodeName identifies the node where the device is available.
    nodeName: ?[]const u8 = null,
    /// NodeSelector defines the nodes where the device is available.
    nodeSelector: ?core_v1.CoreV1NodeSelector = null,
    /// If specified, these are the driver-defined taints.
    taints: ?[]const ResourceV1beta2DeviceTaint = null,
};

/// DeviceAllocationConfiguration gets embedded in an AllocationResult.
pub const ResourceV1beta2DeviceAllocationConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1beta2OpaqueDeviceConfiguration = null,
...
pub const ResourceV1beta2DeviceAllocationResult = struct {
    /// This field is a combination of all the claim and class configuration parameters. Drivers can distinguish between those based on a flag.
    config: ?[]const ResourceV1beta2DeviceAllocationConfiguration = null,
    /// Results lists all allocated devices.
    results: ?[]const ResourceV1beta2DeviceRequestAllocationResult = null,
};
...
pub const ResourceV1beta2DeviceCapacity = struct {
    ...
    requestPolicy: ?ResourceV1beta2CapacityRequestPolicy = null,
    /// Value defines how much of a certain capacity that device has.
    value: api_resource.ApiResourceQuantity,
};

/// DeviceClaim defines how to request devices with a ResourceClaim.
pub const ResourceV1beta2DeviceClaim = struct {
    /// This field holds configuration for multiple potential drivers which could satisfy requests in this claim. It is ignored while allocating the claim.
    config: ?[]const ResourceV1beta2DeviceClaimConfiguration = null,
    /// These constraints must be satisfied by the set of devices that get allocated for the claim.
    constraints: ?[]const ResourceV1beta2DeviceConstraint = null,
    /// Requests represent individual requests for distinct devices which must all be satisfied. If empty, nothing needs to be allocated.
    requests: ?[]const ResourceV1beta2DeviceRequest = null,
};

/// DeviceClaimConfiguration is used for configuration parameters in DeviceClaim.
pub const ResourceV1beta2DeviceClaimConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1beta2OpaqueDeviceConfiguration = null,
...
pub const ResourceV1beta2DeviceClass = struct {
    pub const resource_meta = .{
        ...
        .namespaced = false,
        .list_kind = ResourceV1beta2DeviceClassList,
    };
    ...
    spec: ?ResourceV1beta2DeviceClassSpec = null,
};

/// DeviceClassConfiguration is used in DeviceClass.
pub const ResourceV1beta2DeviceClassConfiguration = struct {
    /// Opaque provides driver-specific configuration parameters.
    @"opaque": ?ResourceV1beta2OpaqueDeviceConfiguration = null,
};

/// DeviceClassList is a collection of classes.
pub const ResourceV1beta2DeviceClassList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource classes.
    items: []const ResourceV1beta2DeviceClass,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
...
pub const ResourceV1beta2DeviceClassSpec = struct {
    /// Config defines configuration parameters that apply to each device that is claimed via this class. Some classses may potentially be satisfied by multiple drivers, so each instance of a vendor configuration applies to exactly one driver.
    config: ?[]const ResourceV1beta2DeviceClassConfiguration = null,
    ...
    selectors: ?[]const ResourceV1beta2DeviceSelector = null,
};

/// DeviceConstraint must have exactly one field set besides Requests.
pub const ResourceV1beta2DeviceConstraint = struct {
...
pub const ResourceV1beta2DeviceCounterConsumption = struct {
...
pub const ResourceV1beta2DeviceDerivedAttribute = struct {
...
pub const ResourceV1beta2DeviceRequest = struct {
    ...
    firstAvailable: ?[]const ResourceV1beta2DeviceSubRequest = null,
    /// Name can be used to reference this request in a pod.spec.containers[].resources.claims entry and in a constraint of the claim.
    name: []const u8,
};

/// DeviceRequestAllocationResult contains the allocation result for one request.
pub const ResourceV1beta2DeviceRequestAllocationResult = struct {
    ...
    tolerations: ?[]const ResourceV1beta2DeviceToleration = null,
};

/// DeviceSelector must have exactly one field set.
pub const ResourceV1beta2DeviceSelector = struct {
    /// CEL contains a CEL expression for selecting a device.
    cel: ?ResourceV1beta2CELDeviceSelector = null,
};

/// DeviceSubRequest describes a request for device provided in the claim.spec.devices.requests[].firstAvailable array. Each is typically a request for a single resource like a device, but can also ask for several identical devices.
pub const ResourceV1beta2DeviceSubRequest = struct {
    ...
    capacity: ?ResourceV1beta2CapacityRequirements = null,
    ...
    derivedAttributes: ?[]const ResourceV1beta2DeviceDerivedAttribute = null,
...
pub const ResourceV1beta2DeviceTaint = struct {
...
pub const ResourceV1beta2DeviceToleration = struct {
...
pub const ResourceV1beta2ExactDeviceRequest = struct {
...
pub const ResourceV1beta2NetworkDeviceData = struct {
...
pub const ResourceV1beta2NodeAllocatableMapping = struct {
...
pub const ResourceV1beta2NodeAllocatableOverhead = struct {
...
pub const ResourceV1beta2NodeAllocatableResource = struct {
    ...
    mapping: ?ResourceV1beta2NodeAllocatableMapping = null,
    ...
    overhead: ?ResourceV1beta2NodeAllocatableOverhead = null,
};

/// OpaqueDeviceConfiguration contains configuration parameters for a driver in a format defined by the driver vendor.
pub const ResourceV1beta2OpaqueDeviceConfiguration = struct {
...
pub const ResourceV1beta2ResourceClaim = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1beta2",
        .kind = "ResourceClaim",
        ...
        .namespaced = true,
        .list_kind = ResourceV1beta2ResourceClaimList,
    };
    ...
    spec: ?ResourceV1beta2ResourceClaimSpec = null,
    /// Status describes whether the claim is ready to use and what has been allocated.
    status: ?ResourceV1beta2ResourceClaimStatus = null,
};

/// ResourceClaimConsumerReference contains enough information to let you locate the consumer of a ResourceClaim. The user must be a resource in the same namespace as the ResourceClaim.
pub const ResourceV1beta2ResourceClaimConsumerReference = struct {
...
pub const ResourceV1beta2ResourceClaimList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource claims.
    items: []const ResourceV1beta2ResourceClaim,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1beta2ResourceClaimSpec = struct {
    /// Devices defines how to request devices.
    devices: ?ResourceV1beta2DeviceClaim = null,
};

/// ResourceClaimStatus tracks whether the resource has been allocated and what the result of that was.
pub const ResourceV1beta2ResourceClaimStatus = struct {
    /// Allocation is set once the claim has been allocated successfully.
    allocation: ?ResourceV1beta2AllocationResult = null,
    /// Devices contains the status of each device allocated for this claim, as reported by the driver. This can include driver-specific information. Entries are owned by their respective drivers.
    devices: ?[]const ResourceV1beta2AllocatedDeviceStatus = null,
    /// ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started. A claim that is in use or might be in use because it has been reserved must not get deallocated.
    reservedFor: ?[]const ResourceV1beta2ResourceClaimConsumerReference = null,
};

/// ResourceClaimTemplate is used to produce ResourceClaim objects.
pub const ResourceV1beta2ResourceClaimTemplate = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1beta2",
        ...
        .namespaced = true,
        .list_kind = ResourceV1beta2ResourceClaimTemplateList,
    };
    ...
    spec: ?ResourceV1beta2ResourceClaimTemplateSpec = null,
};

/// ResourceClaimTemplateList is a collection of claim templates.
pub const ResourceV1beta2ResourceClaimTemplateList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource claim templates.
    items: []const ResourceV1beta2ResourceClaimTemplate,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1beta2ResourceClaimTemplateSpec = struct {
...
pub const ResourceV1beta2ResourcePool = struct {
...
pub const ResourceV1beta2ResourceSlice = struct {
    pub const resource_meta = .{
        .group = "resource.k8s.io",
        .version = "v1beta2",
        .kind = "ResourceSlice",
        ...
        .namespaced = false,
        .list_kind = ResourceV1beta2ResourceSliceList,
    };
    ...
    spec: ResourceV1beta2ResourceSliceSpec,
};

/// ResourceSliceList is a collection of ResourceSlices.
pub const ResourceV1beta2ResourceSliceList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
    /// Items is the list of resource ResourceSlices.
    items: []const ResourceV1beta2ResourceSlice,
    /// Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    kind: ?[]const u8 = null,
    /// Standard list metadata
    metadata: ?meta_v1.MetaV1ListMeta = null,
...
pub const ResourceV1beta2ResourceSliceSpec = struct {
    /// AllNodes indicates that all nodes have access to the resources in the pool.
    allNodes: ?bool = null,
    /// Devices lists some or all of the devices in this pool.
    devices: ?[]const ResourceV1beta2Device = null,
    ...
    pool: ResourceV1beta2ResourcePool,
    /// SharedCounters defines a list of counter sets, each of which has a name and a list of counters available.
    sharedCounters: ?[]const ResourceV1beta2CounterSet = null,
