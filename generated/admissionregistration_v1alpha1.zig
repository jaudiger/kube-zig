...
pub const AdmissionregistrationV1alpha1ApplyConfiguration = struct {
    /// expression will be evaluated by CEL to create an apply configuration. ref: https://github.com/google/cel-spec
    expression: ?[]const u8 = null,
};

/// JSONPatch defines a JSON Patch.
pub const AdmissionregistrationV1alpha1JSONPatch = struct {
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicy = struct {
    pub const resource_meta = .{
        ...
        .namespaced = false,
        .list_kind = AdmissionregistrationV1alpha1MutatingAdmissionPolicyList,
    };
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicyBinding = struct {
    pub const resource_meta = .{
        .group = "admissionregistration.k8s.io",
        .version = "v1alpha1",
        ...
        .namespaced = false,
        .list_kind = AdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingList,
    };
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicyBindingSpec = struct {
    ...
    matchResources: ?AdmissionregistrationV1alpha1MatchResources = null,
    /// paramRef specifies the parameter resource used to configure the admission control policy. It should point to a resource of the type specified in spec.ParamKind of the bound MutatingAdmissionPolicy. If the policy specifies a ParamKind and the resource referred to by ParamRef does not exist, this binding is considered mis-configured and the FailurePolicy of the MutatingAdmissionPolicy applied. If the policy does not specify a ParamKind then this field is ignored, and the rules are evaluated without a param.
    paramRef: ?AdmissionregistrationV1alpha1ParamRef = null,
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicyList = struct {
    /// APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    apiVersion: ?[]const u8 = null,
...
pub const AdmissionregistrationV1alpha1MutatingAdmissionPolicySpec = struct {
    ...
    matchConditions: ?[]const AdmissionregistrationV1alpha1MatchCondition = null,
    ...
    matchConstraints: ?AdmissionregistrationV1alpha1MatchResources = null,
    /// mutations contain operations to perform on matching objects. mutations may not be empty; a minimum of one mutation is required. mutations are evaluated in order, and are reinvoked according to the reinvocationPolicy. The mutations of a policy are invoked for each binding of this policy and reinvocation of mutations occurs on a per binding basis.
    mutations: ?[]const AdmissionregistrationV1alpha1Mutation = null,
    /// paramKind specifies the kind of resources used to parameterize this policy. If absent, there are no parameters for this policy and the param CEL variable will not be provided to validation expressions. If paramKind refers to a non-existent kind, this policy definition is mis-configured and the FailurePolicy is applied. If paramKind is specified but paramRef is unset in MutatingAdmissionPolicyBinding, the params variable will be null.
    paramKind: ?AdmissionregistrationV1alpha1ParamKind = null,
    ...
    variables: ?[]const AdmissionregistrationV1alpha1Variable = null,
};

/// Mutation specifies the CEL expression which is used to apply the Mutation.
pub const AdmissionregistrationV1alpha1Mutation = struct {
    ...
    applyConfiguration: ?AdmissionregistrationV1alpha1ApplyConfiguration = null,
    ...
    jsonPatch: ?AdmissionregistrationV1alpha1JSONPatch = null,
